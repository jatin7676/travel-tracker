-- Create the 'countries' table to store all possible countries.
-- The application expects this table to be pre-populated with a list of all countries and their codes.
...
-- IMPORTANT:
-- You must populate the 'countries' table with data for the application to work.
-- Here are a few examples. You should add all countries you want to be able to track.
...
INSERT INTO countries (country_code, country_name) VALUES ('CD', 'Congo, The Democratic Republic of the');
...
INSERT INTO countries (country_code, country_name) VALUES ('MK', 'Macedonia, The Former Yugoslav Republic of');
...
INSERT INTO countries (country_code, country_name) VALUES ('PS', 'Palestinian Territory, Occupied');
...
INSERT INTO countries (country_code, country_name) VALUES ('CS', 'Serbia and Montenegro');
...
INSERT INTO countries (country_code, country_name) VALUES ('TW', 'Taiwan, Province of China');
